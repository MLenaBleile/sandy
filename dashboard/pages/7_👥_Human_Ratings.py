...
with col4:
    ...
    comparison_data = get_sandy_vs_human_comparison()
    if comparison_data:
...
if component_data and component_data.get('sandy_bread') is not None:
    ...
    fig = go.Figure(data=[
        go.Bar(name='🤖 Sandy', x=components, y=sandy_scores, marker_color='#ff6b9d'),
    ...
    differences = [abs(r - h) for r, h in zip(sandy_scores, human_scores)]
    if differences:
...
with st.expander("💡 Insights & Interpretation"):
    ...
    **Scatter Plot:**
    ...
    - Points above line = humans rate higher than Sandy
...
<div style='text-align: center; color: #999; padding: 1rem;'>
    <p style='font-size: 0.9rem; font-style: italic;'>
        🌺 "The human consensus is a treasure. But also, they really like the sandwiches with puns in the name." — Sandy
    </p>
</div>
""", unsafe_allow_html=True)
